...
class GuardarRutaPage extends StatefulWidget {
  const GuardarRutaPage({Key? key}) : super(key: key);

  @override
  State<GuardarRutaPage> createState() => _GuardarRutaPageState();
}

class _GuardarRutaPageState extends State<GuardarRutaPage> {
  /* Controlado Mapa */
  ...
  void createPolylines() async {
    ...
    if (result.status == 'OK') {
      ...
      polyline = polylineCoordinates.toString();
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              'Hora seleccionada: ${horario.format(context)}',
  ...
  void guardarRuta() async {
    final hora_p = formatTimeOfDay(horario);
    print(hora_p);
    var response = await http.post(
      ...
      body: jsonEncode(<String, dynamic>{
        ...
        "hora_p": hora_p,
        "cant_pasajero": cantidadPasajeros,
